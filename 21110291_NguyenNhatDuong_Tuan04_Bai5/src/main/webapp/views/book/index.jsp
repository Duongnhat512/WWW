                    ...
                    <div class="col-md-4 mb-4 d-flex align-items-stretch" >
                        <div class="card align-items-center">
                            ...
                            <div class="card-body">
                                ...
                                <a href="${pageContext.request.contextPath}/details?id=${book.id}" class="btn btn-primary">Product details</a>
                                <a href="${pageContext.request.contextPath}/cart?action=add&id=${book.id}" class="btn btn-success">Add to cart</a>
                            </div>
                        </div>
                    </div>
                </c:forEach>
